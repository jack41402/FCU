...
void print_addition(const char *n1, const char *n2, const char *sum)
{
...
int main()
{
    ...
    while (1)
    {
        char n1[20], n2[20] , cal_n1[20], cal_n2[20] , sum[20] ;
        ...
        addition(cal_n1, cal_n2, sum) ;
        print_addition(n1, n2, sum) ;
