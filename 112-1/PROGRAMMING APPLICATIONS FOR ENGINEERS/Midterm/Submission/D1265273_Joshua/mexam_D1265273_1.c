...
int main(void) {
	...
	do {
		...
		for (i=0;i<n;++i)
		{
			printf("enter %d coefficients and a constant for equation %d\n",n,i);
			scanf("%d %d %d %d %d %d %d %d %d %d",&A[1][9],&A[2][9],&A[3][9],&A[4][9],&A[5][9],&A[6][9],&A[7][9],&A[8][9],&A[9][9],&C[9]);
		}
		for(i=1;i<10;++i)
	{
		if (A[i][9]==0)
