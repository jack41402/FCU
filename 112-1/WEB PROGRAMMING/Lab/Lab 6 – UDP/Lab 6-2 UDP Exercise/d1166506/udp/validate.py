...
class Validate:
    ...
    def check_ip(self, address: str):
        try:
            ...
            print(f'[ERROR] Other exception in validate.check_ip: {e}, line ', e.__traceback__.tb_lineno)
    ...
    def check_port(self, port: int):
        try:
            ...
            print(f'[ERROR] Other exception in validate.check_port: {e}, line ', e.__traceback__.tb_lineno)
    ...
    def check_number(self, number: int):
        try:
            ...
            print(f'[ERROR] Other exception in validate.check_number: {e}, line ', e.__traceback__.tb_lineno)
