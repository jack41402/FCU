...
r = rand(1,5);
x=(r <= 0.5) % output of the Logical operator will be '1' (true) or '0' (false)
...
% (y > 0) generate a mask (element (0,1) )with the same dimension with y
clear all;
z=[ 1 2 -1; 0 1 -3 ; 1 1 -5];
...
% in-class Exerxise in textbook p.117
...
x2=(a>=0)  % same as before, x2 is look like a mask
