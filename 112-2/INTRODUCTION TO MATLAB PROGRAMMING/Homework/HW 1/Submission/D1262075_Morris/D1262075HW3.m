...
eng_min = min(score(2, :));
fprintf('\n\nstandrad deviation of math :%3.2f\n',math_std);
fprintf('\n\nstandrad deviation of english :%3.2f\n',eng_std);
fprintf('\n\naverage of math :%3.2f\n',math_avg);
fprintf('\n\naverage of english :%3.2f\n',eng_avg);
fprintf('\n\nMaximium of math :%3.2f\n',math_max);
fprintf('\n\nMaximium of english :%3.2f\n',eng_max);
fprintf('\n\nminium of math :%3.2f\n',math_min);
fprintf('\n\nminium of english :%3.2f\n',eng_min);
