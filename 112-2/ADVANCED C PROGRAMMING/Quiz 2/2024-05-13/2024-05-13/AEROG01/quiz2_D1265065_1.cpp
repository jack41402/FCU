...
ostream & operator<<(ostream & output, const Rectangle &r) {
	int i, j;
	//cout << "height" << r.height <<", width" << r.width <<", perimeter" << r.perimeter << ", area"<< r.area << endl;
	printf("height %d, width %d, perimeter %d, area %d\n", r.height, r.width, r.perimeter(), r.area());
