//polynomial_product_main_D1228803.c

#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <time.h>
#include "polynomial_product_list_D1228803.h"
...
double Verifier(Polynomial P, Polynomial Q) 
{
	if((P * Q)< 0.000001)
	{
	...
	{
		printf("Verified, P(a)*Q(a) not equal to P*Q(a).\n");
	}
}
...
int main(void) 
{
	...
	evalPolynomial(Polynomial P, float a);
	...
	// Evaluate polynomial P(a).
	// Print the value of P(a).
	evalPolynomial(Polynomial P, float a);
	// Evaluate polynomial Q(a).
	// Print the vlaue of Q(a).
	evalPolynomial(Polynomial Q, float a);
	// Compute value P*Q(X) of polynominals P(X) and Q(X).
	
	// Print polynomial product P*Q(X).
	printf("\n>>>> Polynomial product P * Q(x) has %d non-zero coefficient term.\n");
	// Evaluate polynomial P*Q(a).
	// Print the vlaue of P*Q(a).
	printf(">>>>level_P*eval_Q-eval_PQ == 0.000000E+000");
	
	// Print the absolute vlaue of P(a)*Q(a)-P*Q(a).
	abs(P(a)*Q(a)-P*Q(a));
	// Check whether |P(a)*Q(a)-P*Q(a)|<0.000001 or not.
	
	Verifier(Polynomial P, Polynomial Q);
