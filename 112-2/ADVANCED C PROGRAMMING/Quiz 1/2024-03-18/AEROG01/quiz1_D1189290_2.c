...
int main(void) {
	...
	printf("AdvancedCProgrammingFCUPurdue22ECEProgramSpringSemester2024InternationalSchoolofTechnologyandManagementFengChiaUniversity");
	printf("\n\n\n");
	printf(">>>> Output data string:\n");
	printf("AdvancedCProgrammingFCUPurdue22ECEProgramSpringSemester2024InternationalSchoolofTechnologyandManagementFengChiaUniversity#####ytisrevinUaihCgneFtnemeganaMdnaygolonhceTfoloohcSlanoitanretnI4202retsemeSgnirpSmargorPECE22eudruPUCFgnimmargorPCdecnavdA");
