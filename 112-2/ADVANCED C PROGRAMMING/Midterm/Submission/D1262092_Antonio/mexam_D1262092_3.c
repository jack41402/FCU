...
int main() {
	...
	fread(&header.Size ,1 ,4 ,fptr);
	fread(&header.Reserved,4 ,1 ,fptr);
	fread(&header.OffsetBits ,1 ,4 ,fptr);
	fread(&header.InfoSize ,1 ,4 ,fptr);
	fread(&header.Width ,1 ,4 ,fptr);
	fread(&header.Height,1,4,fptr);
	fread(&header.Planes ,1 ,4 ,fptr);
	fread(&header.BitPerPixel ,1 ,4 ,fptr);
	fread(&header.Compression ,1 ,4 ,fptr);
	fread(&header.ImageSize ,1 ,4 ,fptr);
	fread(&header.XResolution ,1 ,4 ,fptr);
	fread(&header.YResolution ,1 ,4 ,fptr);
	fread(&header.Colors ,1 ,4 ,fptr);
	fread(&header.ImportantColors ,1 ,4 ,fptr);
