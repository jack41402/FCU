...
int main() {
	...
	/*****************************************/
	fread(input_image,1,2,Header.Type);
	fread(input_image,4,1,Header.Size);
	fread(input_image,4,1,Header.Reserved);
	fread(input_image,4,1,Header.OffsetBits);
	fread(input_image,2,1,Header.InfoSize);
	fread(input_image,4,1,Header.Width);
	fread(input_image,4,1,Header.Height);
	fread(input_image,2,1,Header.Planes);
	fread(input_image,4,1,Header.BitPerPixel);
	fread(input_image,4,1,Header.Compression);
	fread(input_image,4,4,Header.ImageSize);
	fread(input_image,4,1,Header.XResolution);
	fread(input_image,4,1,Header.YResolution);
	fread(input_image,2,1,Header.Colors);
	fread(input_image,2,1,Header.ImportantColors);
	...
	*/
	...
	/*****  Complete this code segment.  *****/
	/*****************************************/  
	fwrite(merged_image,1,2,Header.Type);
	fwrite(merged_image,4,1,Header.Size);
	fwrite(merged_image,4,1,Header.Reserved);
	fwrite(merged_image,Header.OffsetBits,4,1);
	fwrite(merged_image,Header.InfoSize,2,1);
	fwrite(merged_image,Header.Width,4,1);
	fwrite(merged_image,Header.Height,4,1);
	fwrite(merged_image,Header.Planes,2,2);
	fwrite(merged_image,Header.BitPerPixel,4,1);
	fwrite(merged_image,Header.Compression,);
	fwrite(merged_image,Header.ImageSize,);
	fwrite(merged_image,Header.XResolution,);
	fwrite(merged_image,Header.YResolution,);
	fwrite(merged_image,Header.Colors,);
	fwrite(merged_image,Header.ImportantColors,);
