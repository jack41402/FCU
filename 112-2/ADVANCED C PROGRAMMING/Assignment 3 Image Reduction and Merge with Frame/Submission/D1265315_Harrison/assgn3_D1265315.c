...
/* ==================================================================*/
  ...
  merged_header.Size = io_header.Size; // transfer file size to bytes
  ...
  merged_header.XResolution = io_header.XResolution; //horizontal
  merged_header.YResolution = io_header.YResolution; // vertical
 ...
 //merge
  ...
  for (i = 0; i < reduced_header.Height; i++) { // Go through all rows of the reduced image.
    for (j = 0; j < reduced_header.Width; j++) { // Go through all pixels in each row of the reduced image.
	  ...
	  merged_imageData[k_1] = reduced_imageData[k_reduced]; // Copy the pixel
	  ...
	  merged_imageData[k_3] = reduced_imageData[k_reduced];	  merged_imageData[k_3+1] = reduced_imageData[k_reduced+1];
